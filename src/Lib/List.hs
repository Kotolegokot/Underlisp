...
builtin_head _                   = report_undef "head: just one argument required"
...
builtin_tail _                  = report_undef "tail: just one argument required"
...
builtin_null _                 = report_undef "null: just one argument requried"
...
builtin_append _ = report_undef "append: two arguments required"
